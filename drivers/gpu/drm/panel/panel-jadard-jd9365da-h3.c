...
static const struct jadard_init_cmd clockwork_cwu50_init_cmds[] = {
	{ .data = { 0xE0, 0x00 } },
	{ .data = { 0xE1, 0x93 } },
	{ .data = { 0xE2, 0x65 } },
	{ .data = { 0xE3, 0xF8 } },
...
static const struct jadard_panel_desc clockwork_cwu50_desc = {
	.mode = {
		.clock		= 62500,
	...
	.lanes = 4,
	.format = MIPI_DSI_FMT_RGB888,
	.init_cmds = clockwork_cwu50_init_cmds,
	.num_init_cmds = ARRAY_SIZE(clockwork_cwu50_init_cmds),
};
